...
const Profile = ({doctorData}) => {
    ...
    const addQualification = e => {
        ...
        addItem('qualifications', {
            startingDate: "", endingDate: "", degree: "PHD", university: "UNI"
        })
    }
    ...
    const addExperience = e => {
        ...
        addItem('experiences', {
            startingDate: "", endingDate: "", position: "Psycologist", hospital: "Hermilio Valdizan"
        })
    }
    ...
    const addTimeSlot = e => {
        ...
        addItem('timeSlots', {
            day: "Sunday", startingDate: "10:30", endingDate: "02:30"        
        })
    }
                ...
                <div className="grid grid-cols-3 gap-5 mb-[30px]">
                    ...
                    <div>
                        ...
                        <select name="specialization" value={formData.specialization} onChange={handleInputChange} className="form__input py-3.5">
                            ...
                            <option value="neuropsicologo">Neuropsicologo</option>
                ...
                <div className="mb-5">
                        ...
                        {formData.qualifications?.map((item, index)=> (<div key={index}>
                            <div>
                                ...
                                <button onClick={e => deleteQualification(e, index)} className="bg-red-600 p-2 rounded-full
                                text-white text-[18px] mt-2 mb-[38px]">
                                    <AiOutlineDelete/>
                                </button>
                            </div>
                        </div>))}
                    ...
                    <div className="mb-5">
                        ...
                        {formData.experiences?.map((item, index)=> (<div key={index}>
                            <div>
                                ...
                                <button onClick={e => deleteExperience(e, index)} className="bg-red-600 p-2 rounded-full
                                text-white text-[18px] mt-2 mb-[38px]">
                                    <AiOutlineDelete/>
                                </button>
                            </div>
                    ...
                    <div className="mb-5 flex items-center gap-3">
                        ...
                        boder-primaryColor flex items-center justify-center'>
