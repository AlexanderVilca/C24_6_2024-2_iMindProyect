      ...
      <form onSubmit={submitHandler}>
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div className='relative w-[160px] h-[50px]'>
                ...
                truncate cursor-pointer'>{selectedFile ? selectedFile.name: "Actualizar Foto"}</label>
              </div>
            </div>

            <div className="mt-7">
              <button disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[18px]
              leading-[30px] rounded-lg px-4 py-3'>{loading ? (<HashLoader size={25} color='#ffffff'/>) : ('Guardar Cambios')}</button>
            </div>
          </form>
    </div>
  )
