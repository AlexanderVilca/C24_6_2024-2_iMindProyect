          ...
          <div className='flex items-center gap-5'>
            ...
            <div>
              ...
              <div className='flex items-center gap-[6px]'>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[300px]'>dolorem ipsum, quia dolor sit, amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt, ut labore et dolore magnam aliquam quaerat voluptatem.</p>
            </div>
          </div>
